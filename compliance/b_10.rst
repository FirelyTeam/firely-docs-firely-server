...
Binary Resources are used to represent these kind of unstructured data. Firely Server has extended the Patient compartment definition to encompass Binary Resources that are linked to a patient. 
