...
You can download examples of AuditEvent resources generated by the server below:

* :download:`AuditEvent example for R3 (read) <../_static/files/audit-event-examples/R3_read.json>`
* :download:`AuditEvent example for R3 (search) <../_static/files/audit-event-examples/R3_search.json>`
* :download:`AuditEvent example for R3 (custom $erase_operation) <../_static/files/audit-event-examples/R3_erase_operation.json>`
* :download:`AuditEvent example for R4 (read) <../_static/files/audit-event-examples/R4_read.json>`
* :download:`AuditEvent example for R4 (search) <../_static/files/audit-event-examples/R4_search.json>`
* :download:`AuditEvent example for R4 (custom $erase_operation) <../_static/files/audit-event-examples/R4_erase_operation.json>`
* :download:`AuditEvent example for R5 (read) <../_static/files/audit-event-examples/R5_read.json>`
* :download:`AuditEvent example for R5 (search) <../_static/files/audit-event-examples/R5_search.json>`
* :download:`AuditEvent example for R5 (custom $erase operation) <../_static/files/audit-event-examples/R5_erase_operation.json>`