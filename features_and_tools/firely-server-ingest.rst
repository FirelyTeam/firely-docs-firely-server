...
* If a resource is present in a workload more than once, the entries may get processed in parallel and you may end up with a resource having a version that is different from the latest.
