...
.. code-block::
    ...
    "PubSub": {
        "MessageBroker": {
            ...
            "PrefetchCount": 1, // Number of messages to prefetch from the message broker Sets the `PrefetchCout` MassTransit parameter https://masstransit.io/documentation/configuration#receive-endpoints
            "ConcurrencyNumber": 1, // Number of concurrent messages that can be consumed. Sets the `ConcurrentMessageLimit` MassTransit parameter https://masstransit.io/documentation/configuration#receive-endpoints
