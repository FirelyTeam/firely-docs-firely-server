...
#. Starting from this version, a Facade should not have an order greater than or equal to 211. The reason for this is that the MemoryAdministrationConfiguration (order: 211) used by the admin endpoint tries to resolve the ISearchRepository.
