...
:License token: http://fire.ly/vonk/plugins/bulk-data-import/migration
:Description: Token allowing a zero-downtime migration using FSI tool. See :ref:`zero_downtime_migration`.
