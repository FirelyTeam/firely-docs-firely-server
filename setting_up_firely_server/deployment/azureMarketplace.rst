...
- An ingress controller (typically, `NGINX Ingress Controller <https://learn.microsoft.com/en-us/azure/aks/ingress-basic>`_).
- A certificate manager (typically `cert-manager <https://cert-manager.io/>`_). 
- A certificate issuer (see the `available issuers for cert-manager <https://cert-manager.io/docs/usage/issuer/>`_).
